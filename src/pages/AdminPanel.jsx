...
import { FaUsers, FaChartBar, FaCalendarAlt, FaCog, FaBlog } from 'react-icons/fa';
...
const AdminPanel = () => {
  ...
  const [activeTab, setActiveTab] = useState('blog'); // Set 'blog' as default tab
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      default:
        return <BlogManagement />; // Default to Blog Management
    }
  };
